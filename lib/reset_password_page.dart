      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text("Create Your New Password", style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.white)),
            const SizedBox(height: 40),
            _PasswordField(controller: _passCtrl, hint: "New Password"),
            const SizedBox(height: 20),
            _PasswordField(controller: _confirmCtrl, hint: "Confirm Password"),
            const SizedBox(height: 20),
            Row(children: [const Icon(Icons.check, color: Colors.orange), Text(" Remember me", style: GoogleFonts.poppins(color: Colors.white))]),
            const Spacer(),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading ? const CircularProgressIndicator(color: Colors.white) : Text("Continue", style: GoogleFonts.poppins(fontSize: 18, color: Colors.white)),
              ),
            ),
          ],
        ),
